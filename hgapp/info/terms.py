...
copy or adapt the Site’s software, including but not limited to CSS, Python, HTML, JavaScript, or other code.
...
As part of the functionality of the Site, you may, in the future, link your account with online accounts you have with third-party service providers (each such account, a “Third-Party Account”) by either: (1) providing your Third-Party Account login information through the Site; or (2) allowing us to access your Third-Party Account, as is permitted under the applicable terms and conditions that govern your use of each Third-Party Account. 
...
We may in the future allow advertisers to display their advertisements and other information in certain areas of the Site, such as sidebar advertisements or banner advertisements. If you are an advertiser, you shall take full responsibility for any advertisements you place on the Site and any services provided on the Site or products sold through those advertisements. 
...
To expedite resolution and control the cost of any dispute, controversy, or claim related to these Terms and Conditions (each a "Dispute" and collectively, the “Disputes”) brought by either you or us (individually, a “Party” and collectively, the “Parties”), the Parties agree to first attempt to negotiate any Dispute (except those Disputes expressly provided below) informally for at least 35 days before initiating arbitration. Such informal negotiations commence upon written notice from one Party to the other Party.
...
NOTWITHSTANDING ANYTHING TO THE CONTRARY  CONTAINED HEREIN, OUR LIABILITY TO YOU FOR ANY CAUSE WHATSOEVER AND REGARDLESS OF THE FORM OF THE ACTION, WILL AT ALL TIMES BE LIMITED TO THE LESSER OF] [THE AMOUNT PAID, IF ANY, BY YOU TO US DURING THE 12 MONTH PERIOD PRIOR TO ANY CAUSE OF ACTION ARISING OR $25. CERTAIN STATE LAWS DO NOT ALLOW LIMITATIONS ON IMPLIED WARRANTIES OR THE EXCLUSION OR LIMITATION OF CERTAIN DAMAGES. 
...
By selecting the "I Agree" checkbox, creating an account, downloading or using The Contract game or associated website, you are agreeing to be bound by the terms and conditions of this Agreement.

If you do not agree to the terms of this Agreement, do not click on the "I Agree" button and do not download or use The Contract website or create an account. 
...
This Agreement shall remain in effect until terminated by you or I.

I may, in his sole discretion, at any time and for any or no reason, suspend or terminate this Agreement with or without prior notice.

This Agreement will terminate immediately, without prior notice from us, in the event that you fail to comply with any provision of this Agreement. You may also terminate this Agreement by deleting The Contract website and all copies thereof from your mobile device or from your desktop.

Upon termination of this Agreement, you shall cease all use of The Contract website and delete all copies of The Contract website from your mobile device or from your desktop.
...
Personal Data 
Personally identifiable information, such as your user name, email address, and interests, that you voluntarily give to us when you register with the Site or when you choose to participate in various activities related to the Site, such as online chat and message boards. You are under no obligation to provide us with personal information of any kind, however we do require an email address for registration.
...
We may share your information with third parties that perform services for us or on our behalf, including payment processing, data analysis, email delivery, hosting services, or customer service.

Marketing Communications
We do not share your information with third parties for marketing purposes.

Interactions with Other Users 
If you interact with other users of the Site , those users may see your username, profile, and descriptions of your activity, including but not limited to sending invitations to other users, chatting with other users, viewing other users’ user-submitted content, or similar.

Online Postings
When you post comments, contributions or other content to the Site, your posts may be viewed by all users and may be publicly distributed outside the Site in perpetuity. See our Terms and Conditions for more information.

Third-Party Advertisers 
We do not serve third-party ads on The Contract, and we do not share your information with third-party advertisers. 
...
BOT_PRIVACY = """<h4 style="margin-bottom: 5px;">1. Introduction</h4>This Privacy Policy (“Privacy Policy”) applies to the use of the Discord bot service (“Service”, “Bot”) provided by The Contract RPG (hereinafter also referred as “we” or “us”).

If you have any questions or comments about this Privacy Policy, please contact us at spencer@thecontractrpg.com . 
...
<ul><li>What information we may collect about you;</li><li>How we will use the information we collect about you;</li><li>Whether we will disclose your details to anyone else; and</li><li>Your choices and rights regarding the personal information you have provided to us.</li></ul>
...
We may make changes to this Privacy Policy in the future. You should check this page from time to time to ensure you are aware of any changes. Where appropriate we may or may not notify you of such changes.

<h4 style="margin-bottom: 5px">2. Information we may collect about you</h4>We may collect and process the following information which may include your personal data.

Your Discord ID, Discord Username, Discord Server ID & Name, Discord Channel ID & Name, your user preferences, message content prefixed by a '!' character, as well as all the data you supply to us and information provided by you when using the Service (The Contract RPG Discord bot).

We do not access or store emails or phone numbers for our Discord bot users.

<h4 style="margin-bottom: 5px">3. Collecting, processing and using personal data</h4>We only store and process your personal data when you have voluntarily supplied us with it such as installing The Contract's Discord bot on your server or by interacting with it. Your personal data will only be disclosed or otherwise transmitted if this is necessary to implement the contract, render our Services or you have given your prior consent.

<h4 style="margin-bottom: 5px">4. Why we collect information about you – purpose of processing</h4>We will use information about you for delivering our Services to you under the terms of use agreed between us. The processing of information in this way is necessary for us to provide you the Service properly and to ensure the features function properly so that you have the best Service possible.

<h4 style="margin-bottom: 5px">5. Log files</h4>During every interaction with the Service, user data may be stored in protocol files, the so-called log files. The datasets stored here may contain such data as date and time of the interaction, ID and username of the interacting user, the command used, ID and name of the Discord Server in which the interaction took place as well as the ID and name of the Discord Channel the interaction took place in.

<h4 style="margin-bottom: 5px">6. Data sharing</h4>We do NOT sell your personal data and we don’t provide it to anyone outside our organization for any other purpose than the Service you subscribed for or to comply with legal orders.
...
<h4 style="margin-bottom: 5px">7. Your rights</h4>You have the following rights over the way your personal data are processed.

To make a request, please let us know by sending an email to spencer@thecontractrpg.com.
