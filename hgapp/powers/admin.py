...
from .models import Enhancement, Parameter, Base_Power, Drawback, Power_Param, Power, Parameter_Value, \
    ...
    FieldSubstitution, EFFECT, VECTOR, MODALITY, SYS_LEGACY_POWERS, SYS_ALL, SYS_PS2
...
class BasePowerAdmin(admin.ModelAdmin):
    ...
    filter_horizontal = ["enhancements", "drawbacks", "substitutions", "avail_enhancements", "avail_drawbacks",
                         ...
                         "substitutions", "allowed_vectors", "allowed_modalities"]
    fieldsets = (
        (None, {
            'fields': (('name', 'slug'),
                       ('summary', 'is_public'),
                       ...
                       ('description', 'eratta'),
                       'avail_enhancements', 'avail_drawbacks','substitutions')
        }),
